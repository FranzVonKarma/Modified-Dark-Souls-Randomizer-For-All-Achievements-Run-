...
KEY_RESTRICTIONS = {
 ...
 "broken_pendant": [AREA.TOMB_OF_THE_GIANTS_POST_LV, 
  ...
  "key_to_the_seal" : [AREA.TOMB_OF_THE_GIANTS_PRE_LV , AREA.GREAT_HOLLOW , AREA.ASH_LAKE , 
     AREA.BLIGHTTOWN ,AREA.QUELAAGS_DOMAIN , AREA.DEMON_RUINS_NO_LAVA_PRE_LV , AREA.DEMON_RUINS_LAVA , 
     AREA.ANOR_LONDO , AREA.UNDEAD_ASYLUM , AREA.DARKMOON_TOMB , AREA.VALLEY_OF_DRAKES , AREA.PAINTED_WORLD],
  "covenant_of_artorias" : [AREA.TOMB_OF_THE_GIANTS_PRE_LV , AREA.GREAT_HOLLOW , AREA.ASH_LAKE , 
     AREA.BLIGHTTOWN , AREA.DEMON_RUINS_NO_LAVA_PRE_LV , AREA.DEMON_RUINS_LAVA , 
     AREA.ANOR_LONDO , AREA.UNDEAD_ASYLUM , AREA.DARKMOON_TOMB , AREA.VALLEY_OF_DRAKES, AREA.PAINTED_WORLD],  
  "peculiar_doll" : [AREA.TOMB_OF_THE_GIANTS_PRE_LV , AREA.GREAT_HOLLOW , AREA.ASH_LAKE , 
     AREA.BLIGHTTOWN , AREA.DEMON_RUINS_NO_LAVA_PRE_LV , AREA.DEMON_RUINS_LAVA , 
     AREA.ANOR_LONDO , AREA.UNDEAD_ASYLUM , AREA.DARKMOON_TOMB , AREA.VALLEY_OF_DRAKES , AREA.SENS_FORTRESS, AREA.DARKROOT_GARDEN, AREA.DARKROOT_FOREST, AREA.DARKROOT_BASIN]   
   }
